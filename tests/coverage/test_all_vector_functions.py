...
from spomso.cores.sdf_3D import sdf_sphere
...
results, failed = batch_calculate_vector_fields(coor, vf,
...
error_report("vector_fields", results, failed, end_time - start_time)
