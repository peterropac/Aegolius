...
# propagate the UDF
wg_signed = GenericGeometry(wg.propagate, ())
# calculate the SDF
wg_signed.signed(co_resolution)
# extract the interior and sign of the SDF
# it is advisable align at least one edge of the geometry with one of the principle axes
# its best to do the following operation before any Cartesian transforms
wg_signed.sign()
sign_ = wg_signed.create(coor)
