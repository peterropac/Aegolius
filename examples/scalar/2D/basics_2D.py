...
# to see the initial parameters of the geometry, all the applied modifications and transformations use:
print("Geometry:", rectangle)
...
# when a new object is created the history of previous modifications and transformations is lost
print("Geometry:", rectangle)
