...
front_rail = Box(0.80, 0.04, 0.12);
front_rail.rounding(0.01);
front_rail.move((0, 0.42, -0.16))
back_rail = Box(0.80, 0.04, 0.12);
back_rail.rounding(0.01);
back_rail.move((0, -0.42, -0.16))
left_rail = Box(0.04, 0.80, 0.12);
left_rail.rounding(0.01);
left_rail.move((0.42, 0, -0.16))
right_rail = Box(0.04, 0.80, 0.12);
right_rail.rounding(0.01);
right_rail.move((-0.42, 0, -0.16))
