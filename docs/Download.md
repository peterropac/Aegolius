...
Be sure to read [Installation Guide](https://nbviewer.org/github/peterropac/Aegolius/blob/main/examples/aegolius_install.ipynb) for how to install the package.