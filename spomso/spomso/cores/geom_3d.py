...
from spomso.cores.sdf_3D import sdf_parametric_curve_3d, sdf_segmented_curve_3d
...
class Torus(GenericGeometry):
    ...
    def __init__(self, primary_radius: float, secondary_radius: float):
        ...
        self._primary_radius = primary_radius
        self._secondary_radius = secondary_radius
...
class Braid(GenericGeometry):
    ...
    def __init__(self, length: float | int,
                ...
                pitch: float | int):
        GenericGeometry.__init__(self, sdf_braid, primary_radius, secondary_radius, length/2, pitch)
        self._primary_radius = primary_radius
        self._secondary_radius = secondary_radius
        self._length = length/2
        self._pitch = pitch
...
class Arc3D(GenericGeometry):
    ...
    def __init__(self,
        ...
        self._primary_radius = radius
        self._secondary_radius = thickness
...
class ParametricCurve3D(GenericGeometry):
    ...
    def __init__(self,
        ...
        self._parametric_curve = parametric_curve
        self._parametric_curve_parameters = parametric_curve_parameters
...
class SegmentedLine3D(GenericGeometry):
    ...
    def __init__(self, points: list | tuple | np.ndarray, closed: bool = False):
        ...
        GenericGeometry.__init__(self,
                                 sdf_closed_segmented_line_3d if self.closed else sdf_segmented_line_3d,
                                 self._points)
