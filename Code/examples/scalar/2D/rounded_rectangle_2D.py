...
from spomso.cores.geom_2d import RoundedRectangle
...
# define the rounding radii for each corner
rounding = [0.5, 0.2, 0.3, 0.4]

# create a rounded rectangle with side lengths of 2 and 1
final = RoundedRectangle(2, 1, rounding)
